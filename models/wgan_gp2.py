...
def make_discriminator():
    ...
    model.add(Conv1D(16, kernel_size=3, strides=1, input_shape=(1000, 1), padding="same"))
...
def train(dat):
    ...
    real_samples = Input(shape=(X_train.shape[1:],1))
    ...
    for epoch in range(10):
        ...
        # progress bars, etc.
        # generate_samples(generator, output_dir, epoch)
